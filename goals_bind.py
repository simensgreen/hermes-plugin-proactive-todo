...
def build_standing_goal(plan: dict[str, Any], session_id: str) -> str:
    ...
    lines = [
        ...
        "6. In your final response when done, state explicitly that plan verification passed.",
        "7. Treat the PLAN_PROGRESS block below as authoritative for item/plan status.",
        "8. Mark goal DONE only when JUDGE_FLAGS show JUDGE_MAY_MARK_DONE: true "
